document.addEventListener('DOMContentLoaded', function() {
  ...
  function checkScroll() {
    ...
    animatedElements.forEach(element => {
      ...
      const revealPoint = scrollTop + windowHeight - 100;
      
      if (revealPoint > elementTop && scrollTop < elementBottom) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'dc725c95-035c-40ef-b5fe-256748173a79',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'dc725c95-035c-40ef-b5fe-256748173a79';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'dc725c95-035c-40ef-b5fe-256748173a79';
